...
def get_modbus_data():
    ...
    cond_temp = calculate_press_temp(decimal_values[7])
    evap_temp = calculate_press_temp(decimal_values[6])
    ...
    data = {"chimney_temp": decimal_values[0] / 10, "hot_water_temp": decimal_values[1] / 10,
            ...
            "evap_temp": evap_temp, "cond_press": decimal_values[7], "cond_temp": cond_temp, "device_id": "16102024"}
    print("RS485---------->", data)
    return data
